  ...
  return (
    <section className="w-full flex flex-col items-center p-5 lg:p-10">
      ...
      <div className='w-full h-auto  flex-col gap-5 flex justify-start items-start pt-15'>
        <div className='relative w-full md:max-w-[70%] h-[30vh] md:h-[400px] md:rounded-[4rem] rounded-[2rem] mx-auto py-8 px-4 bg-[#FFD1DA] md:ml-[10%]'>
        ...
        <div className='relative flex flex-col justify-center items-center w-full md:max-w-[70%] h-[45vh] md:h-[450px] md:rounded-[4rem] rounded-[2rem] mx-auto py-8 px-4 bg-[#FFD1DA] md:mr-[10%]'>
