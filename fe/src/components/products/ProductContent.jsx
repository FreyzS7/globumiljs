    ...
    <section className="w-full flex flex-col items-center p-5 lg:p-10">
      <div className="w-full max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Product Image */}
          <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden bg-gray-100">
            <Image
          ...
          <div className="flex flex-col gap-2 md:gap-6">
            <div>
              ...
              <p className="text-[1rem] font-semibold text-primary-600">
            ...
            <div>
               ...
               <h2 className="text-[1rem] md:text-xl font-medium mb-3">Multivitamin Terbaik Untuk Ibu Hamil</h2>
      ...
      <div className='w-full h-auto  flex-col gap-5 flex justify-start items-start pt-15'>
        <div className='relative w-full md:max-w-[70%] h-auto md:h-[400px] md:rounded-[4rem] rounded-[2rem] mx-auto py-8 px-4 bg-[#FFD1DA] md:ml-[10%]'>
        ...
        <div className='relative flex flex-col justify-center items-center w-full md:max-w-[70%] h-auto md:h-[450px] md:rounded-[4rem] rounded-[2rem] mx-auto py-8 px-4 bg-[#FFD1DA] md:mr-[10%]'>
          ...
          <div className='flex flex-col justify-center items-center w-[80%] h-full'>
            ...
            <div className='flex flex-col md:flex-row justify-start md:justify-center items-center md:items-start md:w-[80%] w-full h-full gap-2 md:gap-3'>
               <div className='flex flex-col justify-center md:justify-start md:items-start items-center gap-4 w-full md:w-[50%]' >
                 <ul className='list-disc ml-1 flex flex-col gap-1 md:justify-start justify-center md:items-start items-center  text-[3vw] md:text-[1.2rem]  w-full]'>
