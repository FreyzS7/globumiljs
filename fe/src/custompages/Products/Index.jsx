...
import { BASE_URL, UPLOADS_URL, VIEW_PRODUCT_URL, METADATA_BASE_URL } from '../../utils/constant';
...
export default function Products() {
  ...
  // Generate schema for products listing page
  const collectionSchema = products?.data ? generateCollectionPageSchema('products', products.data, 1) : null;
